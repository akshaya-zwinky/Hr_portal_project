...
@Repository
public class ProjectDetailsRepositoryClass implements ProjectDetailsRepositoryInterface {
	@Autowired
	...
	public ProjectDetails getprojectByprojectId(String projectId) {
		...
		ProjectDetails projectDetails=jdbcTemplate.queryForObject(Select_one_project,projectRowMapper ,projectId);
